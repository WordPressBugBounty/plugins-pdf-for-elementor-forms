	...
	public function register_settings_section($widget)
	{
		...
		$widget->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'description' => esc_html__('To customize the filed, copy the shortcode that appears inside each field and paste it above. e.g: [field id="name"]', 'pdf-for-elementor-forms'),
			]
		);
		$widget->add_control(
		...
		$widget->add_control(
			$this->get_control_id('attach_email_pdf_list'),
			[
				'label' => esc_html__('List of attached emails ', 'pdf-for-elementor-forms'),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$widget->add_control(
			$this->get_control_id('save_dropbox'),
			[
